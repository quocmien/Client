                ...
                <div class="accordion accordion-rounded" id="accordion-1">
                    <div class="card card-box card-sm bg-light">
                        ...
                        <vue-slide-toggle :open="toggleState[0][0]">
                            <div
                                class="card-body"
                            >Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede. Donec nec justo eget felis facilisis fermentum.</div>
                        </vue-slide-toggle>
                    </div>
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading-3">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[0][2], collapsed: !toggleState[0][2]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading-4">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[0][3], collapsed: !toggleState[0][3]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading2-1">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[1][0], collapsed: !toggleState[1][0]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading2-2">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[1][1], collapsed: !toggleState[1][1]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading2-3">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[1][2], collapsed: !toggleState[1][2]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading3-1">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[2][0], collapsed: !toggleState[2][0]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading3-2">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[2][1], collapsed: !toggleState[2][1]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading3-3">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[2][2], collapsed: !toggleState[2][2]}"
                    ...
                    <div class="card card-box card-sm bg-light">
                        <div class="card-header" id="heading3-4">
                            <h2 class="card-title">
                                <a
                                    class="toggle-button"
                                    :class="{expanded: toggleState[2][3], collapsed: !toggleState[2][3]}"
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-9 col-xl-7">
                        <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                            ...
                            <div class="col-auto">
                                <nuxt-link to="/pages/contact" class="btn btn-outline-white">
