    ...
    <main class="main">
        ...
        <div class="container">
            <div
                ...
                v-lazy:background-image="'./images/about-header-bg.jpg'"
            >
        ...
        <div class="page-content pb-0">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5 mb-3 mb-lg-0">
                            ...
                            <p
                                class="mb-2"
                            >Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Suspendisse potenti. Sed egestas, ante et vulputate volutpat, uctus metus libero eu augue.</p>
                        ...
                        <div class="col-lg-6 offset-lg-1">
                            <div class="about-images">
                                <img
                                    v-lazy="'./images/about/img-1.jpg'"
                                    alt
                                    class="about-img-front"
                                />
                                <img v-lazy="'./images/about/img-2.jpg'" alt class="about-img-back" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img v-lazy="'./images/team/member-1.jpg'" alt="member photo" />
                    ...
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img v-lazy="'./images/team/member-2.jpg'" alt="member photo" />
                    ...
                    <div class="col-md-4">
                        <div class="member member-anim text-center">
                            <figure class="member-media">
                                <img v-lazy="'./images/team/member-3.jpg'" alt="member photo" />
            ...
            <div class="about-testimonials bg-light-2 pt-6 pb-6">
                <div class="container">
                    ...
                    <div class="swiper-carousel swiper-testimonials-photo swiper-1">
                    ...
                    <div class="owl-carousel owl-simple owl-testimonials-photo"></div>
                </div>
            </div>
        </div>
    </main>
