            ...
            <div class="container">
                    ...
                    <div class="col-md-6">
                        <div class="banner banner-cat">
                            ...
                            <div class="banner-content">
                                ...
                                <nuxt-link to="/shop/sidebar/list" class="banner-link">Shop Now</nuxt-link>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-cat">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/3cols/banner-1.jpg'" alt="Banner" />
                            </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-cat">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/3cols/banner-2.jpg'" alt="Banner" />
                            </a>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="banner banner-cat">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/3cols/banner-3.jpg'" alt="Banner" />
                            </a>
                    ...
                    <div v-swiper:swiper="carouselSetting">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="banner banner-cat bg-transparent">
                                    <a href="javascript:;">
                                        <img
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6 col-lg-3">
                        <div class="banner banner-cat banner-link-anim banner-large">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/grid/banner-1.jpg'" alt="Banner" />
                            </a>
                    ...
                    <div class="col-sm-6 col-lg-3 order-lg-last">
                        <div class="banner banner-cat banner-link-anim banner-large">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/grid/banner-4.jpg'" alt="Banner" />
                            </a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner banner-cat banner-badge">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/grid2/banner-1.jpg'" alt="Banner" />
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="banner banner-cat banner-badge">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/grid2/banner-2.jpg'" alt="Banner" />
                            </a>
                        ...
                        <div class="banner banner-cat banner-badge">
                            <a href="javascript:;">
                                <img v-lazy="'./images/category/grid2/banner-3.jpg'" alt="Banner" />
                            </a>
